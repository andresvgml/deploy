...
return [
     ...
     */
    'checks' => [
        'certificate' => App\CheckDefinitions\Certificate::class,
        'cpu'         => App\CheckDefinitions\Cpu::class,
        'diskspace'   => App\CheckDefinitions\Diskspace::class,
        'domain'      => App\CheckDefinitions\Domain::class,
        'memory'      => App\CheckDefinitions\Memory::class,
    ],
     ...
     */
    'next_run_in_minutes' => env('SERVER_MONITOR_NEXT_RUN_IN_MINUTES', 5),
     ...
     */
    'process_manipulator' => \App\Manipulators\CommandManipulator::class,
    ...
    /*
     * Thresholds for expiration certificates.
     */
    'days_expiration_certificates_threshold' => [
        'warning' => 5,
        'fail' => 1,
    ],

    /*
     * Thresholds for memory alert.
     */
    ...
    /*
     * Thresholds for expiration domains.
     */
    'days_expiration_domains_threshold' => [
        'warning' => 5,
        'fail' => 1,
    ],

    /*
     * Thresholds for cpu usage alert.
     */
    'cpu_percentage_threshold' => [
        'warning' => 95,
        'fail' => 99,
    ],
